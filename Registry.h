...
typedef std::vector<CString> CSysStringVector;
typedef std::vector<unsigned char> CByteBuffer;
...
public:
  ...
  LONG SetValue_Strings(LPCTSTR valueName, const CSysStringVector &strings);
  LONG GetValue_Strings(LPCTSTR valueName, CSysStringVector &strings);
  ...
  LONG QueryValue(LPCTSTR name, CString &value);
